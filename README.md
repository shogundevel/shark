...
The next update is gonna be big, introducing SharkG: the statically typed dialect of Shark!

Initial benchmarks shows SharkG is 12 times **faster** and consumes munch (around 1/3) **less memory** than Shark **when compiled to native binary code**.
